...
class AdotarCachorros extends StatefulWidget {
  const AdotarCachorros({super.key});

  @override
  State<AdotarCachorros> createState() => _AdotarCachorrosState();
}

class _AdotarCachorrosState extends State<AdotarCachorros> {
            ...
            child: Column(
              children: [
                ...
                TextField(
                  ...
                  onChanged: (value) => _nomeDono = value,
                ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Adotar - Cachorros'),
      ),
      drawer: Drawer(
        child: Container(
